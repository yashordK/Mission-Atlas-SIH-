// blockchainConfig.js — Polygon Amoy Testnet (Chain ID 80002)
...
export const CONTRACT_ADDRESS = '0x33985e0e572b06fd2f8324e853b29ba5e90a86d1';
...
export const CONTRACT_ABI = [
  ...
  },
  {
    inputs: [
      { internalType: 'bytes32', name: 'idHash',      type: 'bytes32' },
      { internalType: 'bytes32', name: 'guideIdHash', type: 'bytes32' },
    ],
    name: 'assignGuide',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true,  internalType: 'bytes32', name: 'idHash',       type: 'bytes32' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'bytes32', name: 'idHash',      type: 'bytes32' },
      { indexed: true, internalType: 'bytes32', name: 'guideIdHash', type: 'bytes32' },
